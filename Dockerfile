...
# ── Tous les custom nodes réellement utilisés par le workflow ────────────────
# ── (liste validée sur pod vierge le 05/07/2026) ─────────────────────────────
...
# ── Pin des versions exactes validées sur le pod (05/07/2026) ────────────────
...
# ── FIX : désactiver Dynamic VRAM (comfy-aimdo) — confirmé nécessaire ────────
# ── pour la vitesse ET la stabilité de la boucle sur un pod validé ───────────
